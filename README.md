...
- :heavy_check_mark: Advanced knowledge: C/C++ (Qt, Boost), Python (Django, Django RESTframework).
- :heavy_check_mark: Basic knowledge: SQL, HTML, CSS, PHP, JavaScript, Bootstrap, React, Linux.
- :heavy_check_mark: Experience with: Docker (Docker Compose, Docker Swarm), MySQL, PostgreSQL, MongoDB, Redis, Webpack, Celery, Ansible, Vagrant, Kubernetes.
